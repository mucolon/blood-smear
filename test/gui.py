...
class GUI():
    ...
    def start(self):
        ...
        label_speed = tk.Label(
            ...
            self.master, text="Linear speeds for different Hematocrit percentages are listed below their respective buttons", font=("Verdana Bold", 16)).grid(row=1, columnspan=4, pady=20)
