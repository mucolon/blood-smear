...
class GUI():
    ...
    def start(self):
        ...
        button1 = tk.Button(
            self.master, text="Hematocrit 1").grid(row=2, column=0, ipady=15, ipadx=25, padx=20, pady=20)
        button2 = tk.Button(
            self.master, text="Hematocrit 2").grid(row=2, column=1, ipady=15, ipadx=25, padx=20, pady=20)
        button3 = tk.Button(
            self.master, text="Hematocrit 3").grid(row=2, column=2, ipady=15, ipadx=25, padx=20, pady=20)
        button4 = tk.Button(
            self.master, text="Hematocrit 4").grid(row=2, column=3, ipady=15, ipadx=25, padx=20, pady=20)
        button5 = tk.Button(
            self.master, text="Hematocrit 5").grid(row=4, column=0, ipady=15, ipadx=25, padx=20, pady=20)
        button6 = tk.Button(
            self.master, text="Hematocrit 6").grid(row=4, column=1, ipady=15, ipadx=25, padx=20, pady=20)
        button7 = tk.Button(
            self.master, text="Hematocrit 7").grid(row=4, column=2, ipady=15, ipadx=25, padx=20, pady=20)
        button8 = tk.Button(
            self.master, text="Hematocrit 8").grid(row=4, column=3, ipady=15, ipadx=25, padx=20, pady=20)
        ...
        quit_button = tk.Button(self.master, text="Quit").grid(
