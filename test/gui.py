...
class GUI():
    ...
    def start(self):
        ...
        button1 = tk.Button(
            self.master, text="Hematocrit 1", font=("Verdana Bold", 18)).grid(row=2, column=0, ipady=15, ipadx=20, padx=15, pady=20)
        button2 = tk.Button(
            self.master, text="Hematocrit 2", font=("Verdana Bold", 18)).grid(row=2, column=1, ipady=15, ipadx=20, padx=15, pady=20)
        button3 = tk.Button(
            self.master, text="Hematocrit 3", font=("Verdana Bold", 18)).grid(row=2, column=2, ipady=15, ipadx=20, padx=15, pady=20)
        button4 = tk.Button(
            self.master, text="Hematocrit 4", font=("Verdana Bold", 18)).grid(row=2, column=3, ipady=15, ipadx=20, padx=15, pady=20)
        button5 = tk.Button(
            self.master, text="Hematocrit 5", font=("Verdana Bold", 18)).grid(row=4, column=0, ipady=15, ipadx=20, padx=15, pady=20)
        button6 = tk.Button(
            self.master, text="Hematocrit 6", font=("Verdana Bold", 18)).grid(row=4, column=1, ipady=15, ipadx=20, padx=15, pady=20)
        button7 = tk.Button(
            self.master, text="Hematocrit 7", font=("Verdana Bold", 18)).grid(row=4, column=2, ipady=15, ipadx=20, padx=15, pady=20)
        button8 = tk.Button(
            self.master, text="Hematocrit 8", font=("Verdana Bold", 18)).grid(row=4, column=3, ipady=15, ipadx=20, padx=15, pady=20)
